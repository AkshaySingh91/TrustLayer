          ...
          try {
            ...
            chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
              if (tabs[0]?.url) {
                ...
                hideLoadingState();
                cookieList.innerHTML = "<p style='color: red;'>Error: No active tab found</p>";
              }
            });
          } catch (error) {
            console.error("❌ Error scanning cookies:", error);
            hideLoadingState();
            cookieList.innerHTML = "<p style='color: red;'>Error scanning cookies. Please try again.</p>";
          }
        });
        ...
        if (cookieList) {
            cookieList.innerHTML = `
                <div style="color: red; padding: 20px; text-align: center;">
                    ...
                    <p>Cookie Guard encountered an error. Please reload the extension.</p>
